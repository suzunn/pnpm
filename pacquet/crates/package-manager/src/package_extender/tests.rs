...
fn extends_manifest_with_missing_dependency() {
    ...
    let extender = PackageExtender::new(&extensions);
...
fn empty_extender_is_noop() {
    let extender = PackageExtender::new(&IndexMap::new());
...
fn checksum_order_invariance_outer_keys() {
    ...
    let extender1 = PackageExtender::new(&ext1);
    let extender2 = PackageExtender::new(&ext2);
